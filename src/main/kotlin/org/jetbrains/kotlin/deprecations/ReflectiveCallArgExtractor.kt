 ...
 *
 * Limitation: [maskComments] does not special-case triple-quoted strings (unlike
 * [maskCommentsAndStrings]) — a `callReflective*(...)` call written as literal text inside a
 * `"""…"""` block would still be picked up. Not a concern in practice: this convention is used
 * in real reflective-dispatch code, not inside embedded-script string literals.
 */
